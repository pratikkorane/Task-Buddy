...
const Navbar2 = ({ onSearch, placeholderText }) => {
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 fs-5 mb-lg-0">
              ...
              {/* New Dropdown for Login Options */}
              <li className="nav-item dropdown">
                <a
                  className="nav-link active dropdown-toggle"
                  href="#"
                ...
                <ul className="dropdown-menu">
                  <li>
                    <a className="dropdown-item" onClick={() => navigate("/login/customer")}>
                      Login as Customer
                    </a>
                  </li>
                  <hr className="dropdown-divider" />
                  <li>
                    <a className="dropdown-item" onClick={() => navigate("/login/tasker")}>
                      Login as Tasker
                    </a>
                  </li>
                  <hr className="dropdown-divider" />
                  <li>
                    <a className="dropdown-item" onClick={() => navigate("/login/admin")}>
                      Login as Admin
                    </a>
                  </li>
                </ul>
